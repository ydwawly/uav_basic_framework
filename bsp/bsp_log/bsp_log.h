...
#ifndef UAV_BAICE_FRAMEWORK_V1_0_BSP_LOG_H
#define UAV_BAICE_FRAMEWORK_V1_0_BSP_LOG_H
...
#else
// information level
#define LOGINFO(format, ...) LOG_PROTO("I:", RTT_CTRL_TEXT_BRIGHT_BLUE, format, ##__VA_ARGS__)
// warning level
...
#endif //UAV_BAICE_FRAMEWORK_V1_0_BSP_LOG_H